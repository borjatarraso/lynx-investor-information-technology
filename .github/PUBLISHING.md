...
2. Add a new pending publisher:
   - **PyPI project name**: lynx-investor-information-technology
   - **Owner**: `borjatarraso`
   - **Repository**: `lynx-investor-information-technology`
...
# then:
git tag -a v5.2 -m "lynx-investor-information-technology v5.2"
