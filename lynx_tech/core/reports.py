...
from lynx_tech.core.storage import get_reports_dir, save_binary, save_json, save_text
from lynx_tech.models import Filing

DOWNLOAD_HEADERS = {"User-Agent": "Mozilla/5.0 (compatible; LynxTech/0.1)", "Accept-Encoding": "gzip, deflate"}
EDGAR_HEADERS = {"User-Agent": "LynxTech/0.1 lynx-tech-research@example.com", "Accept-Encoding": "gzip, deflate"}
