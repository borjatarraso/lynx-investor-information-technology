...
def export_report(report: AnalysisReport, fmt, output_path: Optional[Path] = None) -> Path:
    ...
    from lynx_tech.core.storage import get_company_dir
    ...
    if fmt == ExportFormat.TXT:
        from lynx_tech.export.txt_export import export_txt; return export_txt(report, output_path)
    elif fmt == ExportFormat.HTML:
        from lynx_tech.export.html_export import export_html; return export_html(report, output_path)
    elif fmt == ExportFormat.PDF:
        from lynx_tech.export.pdf_export import export_pdf; return export_pdf(report, output_path)
