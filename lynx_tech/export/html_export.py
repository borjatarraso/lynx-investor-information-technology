...
Tech Category: {esc(_ev(p.tech_category))} &nbsp;|&nbsp;
...
""")
    ...
    if report.tech_quality:
        ...
        parts.append('<div class="card"><h2>Tech Quality Indicators</h2>')
        parts.append(_metric_table([
    ...
    if report.market_intelligence:
        ...
        if mi.benchmark_name or mi.sector_etf_name:
            parts.append("<h2>Tech Benchmark &amp; Sector Context</h2>")
            ctx_fields = []
    ...
    if c.screening_checklist:
        parts.append("<h2>Tech Screening Checklist</h2>")
