...
class ReportView(VerticalScroll):
    ...
    def add_stage(self, stage: str, report: AnalysisReport) -> None:
        ...
        if stage == "profile":
            ...
            self._mount_section("Tech Quality", _build_tech_quality(report))
...
class LynxTechApp(PagingAppMixin, App):
    ...
    def on_mount(self) -> None:
        from lynx_tech.tui.themes import register_all_themes, THEME_NAMES
        try:
    ...
    def action_cycle_theme(self) -> None:
        from lynx_tech.tui.themes import THEME_NAMES
    ...
    def action__ee_lynx(self) -> None:
        from lynx_tech.easter import LYNX_ASCII, WOLF_ASCII, BULL_ASCII
        import random
...
def _build_profile_table(r: AnalysisReport) -> DataTable:
    ...
    _r2(t, "Tech Category", _s(p.tech_category.value if hasattr(p.tech_category, "value") else p.tech_category))
...
def _build_tech_quality(r: AnalysisReport) -> Static:
    ...
    def rel(key: str) -> Relevance:
        return _get_rel(key, tier, "tech_quality", stage)
